...
(function($) {
  ...
  Drupal.behaviors.fileResup = {
    ...
    attach: function(context, settings) {
      console.log("drupal behaviours - attach");
      ...
      $('.file-resup', context).each(function () {
        ...
        console.log("upload button id");
        console.log($uploadButton.attr('id'));
        ...
        console.log(settings.file_resup.chunk_size);
